...
namespace Kwetter_Security_API.Dal.Migrations
{
    ...
    [Migration("20230106232359_AllowNullableRemovalDateFollow")]
    partial class AllowNullableRemovalDateFollow
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kwetter_Security_API.Dal.Models.UserFollow", b =>
                {
                    b.HasOne("Kwetter_Security_API.Dal.Models.User", "FollowingUser")
                        .WithMany()
                        .HasForeignKey("FollowingUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kwetter_Security_API.Dal.Models.User", "User")
                        .WithMany()
